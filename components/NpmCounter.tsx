...
export function NpmCounter() {
  ...
  return (
    <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-white/5 border border-white/10 text-base font-medium text-slate-300 animate-fade-in-up hover:bg-white/10 transition-colors">
      <svg viewBox="0 0 780 250" className="w-10 h-auto fill-red-500">
